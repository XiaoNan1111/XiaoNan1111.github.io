...
### Part I. 编程技能（第1-4周）
- 学习 **Linux** 和 **R** 编程基础。
- **第1周**：课程介绍、入门任务（环境配置，Markdown 和 Docker）。
- **第2-4周**：Linux 命令、Bash 脚本、R 基础 、Python基础。

### Part II. 基础与 NGS 数据分析（第5-9周）
- 学习 **NGS** 数据分析及 **R** 数据处理。
- **第5周**：NGS 基础，Reads Mapping。
- **第6-9周**：RNA-seq 差异表达分析，GO/KEGG/GSEA 功能富集分析。

### Part III. 机器学习与人工智能（第10-16周）
- 了解机器学习算法及其在生物信息学中的应用。

### Part IV. 单细胞与高通量筛选数据分析（第11-16周）
- 学习 **单细胞测序** 数据分析和高通量筛选设计。
